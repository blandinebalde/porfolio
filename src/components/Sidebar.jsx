    ...
    <aside className="sidebar" ref={sidebarRef}>
      <div className="sidebar-wrapper">
        ...
        <div className="sidebar-header">
          <h1 className="sidebar-name animate-name">{t('header.name')}</h1>
          <p className="sidebar-title animate-title">{t('header.title')}</p>
          <p className="sidebar-tagline animate-tagline">{t('header.tagline')}</p>
        </div>
        ...
        <div className="sidebar-social">
          <a href="https://github.com/blandinebalde" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="social-icon">
          ...
          <a href="mailto:blandinebalde@gmail.com" aria-label="Email" className="social-icon">
          ...
          <a href="https://www.linkedin.com/in/blandine-balde-00b24a1a3/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="social-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
